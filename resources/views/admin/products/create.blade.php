...
<div class="admin-topbar" style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:16px;margin-bottom:24px;padding-bottom:18px;border-bottom:1px solid var(--gray-200);">
    <div>
        ...
        <h1 class="admin-page-title" style="margin:0;font-size:clamp(1.4rem,3vw,1.85rem);">Add New Product</h1>
        <p class="text-sm text-muted" style="margin:4px 0 0;">Configure multi-tier pricing, inventory rules, specifications, and images</p>
    </div>
        ...
        <div style="display:flex;flex-direction:column;gap:20px;min-width:0;">
                ...
                <div class="form-grid-2 mb-4">
                    <div class="form-group mb-0">
                        ...
                        <input type="text" name="sku" class="form-control {{ $errors->has('sku') ? 'is-invalid' : '' }}"
                               value="{{ old('sku') }}" placeholder="e.g. FISH-SAL-500">
                    ...
                    <div class="form-group mb-0" style="background:#f8fafc;padding:14px;border-radius:12px;border:1px solid #e2e8f0;">
                        ...
                        <div class="currency-input-group">
                            ...
                            <input type="number" name="retail_price" step="0.01" min="0"
                                   ...
                                   value="{{ old('retail_price', '0.00') }}" placeholder="0.00" required>
                        </div>
                        <div style="margin-top:10px;">
                            <label style="font-size:0.78rem;color:var(--text-muted);display:block;margin-bottom:3px;">Retail Default MOQ</label>
                            <input type="number" name="moq" min="1" class="form-control form-control-sm" value="{{ old('moq', 1) }}" placeholder="1">
                        </div>
                    ...
                    <div class="form-group mb-0" style="background:#f8fafc;padding:14px;border-radius:12px;border:1px solid #e2e8f0;">
                        ...
                        <div class="currency-input-group">
                            ...
                            <input type="number" name="walkin_price" step="0.01" min="0"
                                   ...
                                   value="{{ old('walkin_price', '0.00') }}" placeholder="0.00" required>
                        </div>
                    ...
                    <div class="form-group mb-0" style="background:#f8fafc;padding:14px;border-radius:12px;border:1px solid #e2e8f0;">
                        ...
                        <div class="currency-input-group">
                            ...
                            <input type="number" name="wholesale_price" step="0.01" min="0"
                                   ...
                                   value="{{ old('wholesale_price', '0.00') }}" placeholder="0.00" required>
                        </div>
                        <div style="margin-top:10px;">
                            <label style="font-size:0.78rem;color:var(--text-muted);display:block;margin-bottom:3px;">Wholesale MOQ (Units)</label>
                            <input type="number" name="moq_wholesale" min="1" class="form-control form-control-sm" value="{{ old('moq_wholesale', 5) }}" placeholder="5">
                        </div>
                    ...
                    <div class="form-group mb-0" style="background:#f8fafc;padding:14px;border-radius:12px;border:1px solid #e2e8f0;">
                        ...
                        <div class="currency-input-group">
                            ...
                            <input type="number" name="trading_price" step="0.01" min="0"
                                   class="form-control"
                                   value="{{ old('trading_price') }}" placeholder="Leave blank for RFQ">
                        </div>
                        <div style="margin-top:10px;">
                            <label style="font-size:0.78rem;color:var(--text-muted);display:block;margin-bottom:3px;">Trading MOQ (Units / Cartons)</label>
                            <input type="number" name="moq_trading" min="1" class="form-control form-control-sm" value="{{ old('moq_trading', 10) }}" placeholder="10">
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group mb-0" style="background:#f8fafc;padding:12px 14px;border-radius:10px;border:1px solid #e2e8f0;">
                            ...
                            <div class="currency-input-group">
                                ...
                                <input type="number" name="price_sgd" step="0.01" min="0" class="form-control"
                                       value="{{ old('price_sgd') }}" placeholder="e.g. 9.50 (Optional)">
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-0" style="background:#f8fafc;padding:12px 14px;border-radius:10px;border:1px solid #e2e8f0;">
                            ...
                            <div class="currency-input-group">
                                ...
                                <input type="number" name="price_usd" step="0.01" min="0" class="form-control"
                                       value="{{ old('price_usd') }}" placeholder="e.g. 7.20 (Optional)">
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-0" style="background:#f8fafc;padding:12px 14px;border-radius:10px;border:1px solid #e2e8f0;">
                            ...
                            <div class="currency-input-group">
                                ...
                                <input type="number" name="wholesale_price_sgd" step="0.01" min="0" class="form-control"
                                       value="{{ old('wholesale_price_sgd') }}" placeholder="Optional">
                            </div>
                        </div>
            ...
            <div class="card">
                ...
                <div class="form-grid-3 mb-4">
                    <div class="form-group mb-0">
                        ...
                        <input type="text" name="weight" class="form-control" value="{{ old('weight') }}" placeholder="e.g. 500g, 1kg pack">
                    </div>
                    <div class="form-group mb-0">
                        ...
                        <select name="unit" class="form-control" required>
                            @foreach(['pcs' => 'Pieces (pcs)', 'kg' => 'Kilogram (kg)', 'pack' => 'Pack', 'box' => 'Box', 'tray' => 'Tray', 'bag' => 'Bag', 'carton' => 'Carton'] as $val => $lbl)
                                <option value="{{ $val }}" {{ old('unit', 'pack') == $val ? 'selected' : '' }}>{{ $lbl }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group mb-0">
                        <label class="form-label">Stock Quantity <span class="required">*</span></label>
                        <input type="number" name="stock_quantity" min="0" class="form-control" value="{{ old('stock_quantity', 50) }}" required>
                    </div>
                </div>
            ...
            <div class="card">
                ...
                <div id="specsContainer">
                    <!-- Dynamic spec rows will be rendered here -->
                </div>
                <div id="noSpecsNotice" style="text-align:center;padding:18px;background:#f8fafc;border-radius:8px;border:1px dashed #cbd5e1;color:#64748b;font-size:0.85rem;">
        ...
        <div style="display:flex;flex-direction:column;gap:20px;min-width:0;">
            ...
            <div class="card">
                ...
                <div id="thumbPreviewBox" style="width:100%;height:190px;background:#f8fafc;border-radius:12px;border:1.5px dashed var(--gray-300);display:flex;flex-direction:column;align-items:center;justify-content:center;margin-bottom:12px;overflow:hidden;position:relative;cursor:pointer;transition:all 0.2s ease"
                    ...
                    <div id="thumbPlaceholder" style="text-align:center;padding:16px;">
                    ...
                    <img id="thumbPreviewImg" src="" alt="Thumbnail preview" style="display:none;width:100%;height:100%;object-fit:cover">
                    
                    <button type="button" id="thumbClearBtn" onclick="event.stopPropagation(); clearThumbnailSelection()"
                            style="display:none;position:absolute;top:8px;right:8px;background:rgba(15,23,42,0.75);color:white;border:none;border-radius:50%;width:26px;height:26px;cursor:pointer;font-size:0.75rem;align-items:center;justify-content:center;backdrop-filter:blur(4px);">
                        ✕
                    </button>
                </div>
                ...
                <input type="hidden" name="gallery_thumbnail" id="galleryThumbnailInput">
            </div>
                ...
                <div style="display:flex;flex-direction:column;gap:8px;">
                    ...
                    <div class="toggle-switch-card">
                        ...
                        <label class="switch-control">
                            ...
                            <input type="checkbox" name="is_walkin_available" id="is_walkin_available" value="1" {{ old('is_walkin_available', '0') == '1' ? 'checked' : '' }}>
                            <span class="switch-slider"></span>
                        </label>
                    </div>
                    ...
                    <div class="toggle-switch-card">
                        ...
                        <label class="switch-control">
                            ...
                            <input type="checkbox" name="is_rfq_only" id="is_rfq_only" value="1" {{ old('is_rfq_only', '0') == '1' ? 'checked' : '' }}>
                            <span class="switch-slider"></span>
                        </label>
                    </div>
                    ...
                    <div class="toggle-switch-card">
                        ...
                        <label class="switch-control">
                            ...
                            <input type="checkbox" name="track_stock" id="track_stock" value="1" {{ old('track_stock', '1') == '1' ? 'checked' : '' }}>
                            <span class="switch-slider"></span>
                        </label>
                    </div>
                </div>
