            ...
            <div class="card">
                ...
                <div class="form-group mb-4">
                    ...
                    <input type="text" name="name" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}"
                           value="{{ old('name', $product->getRawOriginal('name')) }}" placeholder="e.g. Atlantic Salmon Fillet (500g)" required>
                ...
                <div class="form-grid-2 mb-4" style="background:#f8fafc;padding:12px 14px;border-radius:10px;border:1px solid #e2e8f0;">
                    <div class="form-group mb-0">
                        ...
                        <input type="text" name="name_zh" class="form-control"
                               value="{{ old('name_zh', $product->name_zh) }}" placeholder="e.g. 挪威大西洋三文鱼柳 (500g)">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="short_description" class="form-control" maxlength="500"
                           value="{{ old('short_description', $product->getRawOriginal('short_description')) }}" placeholder="Crisp 1-2 sentence highlight shown in catalogue cards">
                </div>
                ...
                <div class="form-grid-2 mb-4" style="background:#f8fafc;padding:12px 14px;border-radius:10px;border:1px solid #e2e8f0;">
                    <div class="form-group mb-0">
                        ...
                        <input type="text" name="short_description_zh" class="form-control" maxlength="500"
                               value="{{ old('short_description_zh', $product->short_description_zh) }}" placeholder="简短亮点说明...">
                    </div>
                    <div class="form-group mb-0">
                        ...
                        <input type="text" name="short_description_bm" class="form-control" maxlength="500"
                               value="{{ old('short_description_bm', $product->short_description_bm) }}" placeholder="Keterangan ringkas...">
                    </div>
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea name="description" class="form-control" rows="4" placeholder="Detailed product culinary advisory, tasting notes, thaw instructions, packaging details...">{{ old('description', $product->getRawOriginal('description')) }}</textarea>
                </div>
                ...
                <div class="form-grid-2 mb-0" style="background:#f8fafc;padding:12px 14px;border-radius:10px;border:1px solid #e2e8f0;">
                    <div class="form-group mb-0">
                        ...
                        <textarea name="description_zh" class="form-control" rows="3" placeholder="详细中文描述、烹饪建议、解冻方式...">{{ old('description_zh', $product->description_zh) }}</textarea>
                    </div>
                    <div class="form-group mb-0">
                        <label class="form-label" style="color:#059669;font-size:0.8rem;font-weight:700;">🇲🇾 Full Description (Malay)</label>
                        <textarea name="description_bm" class="form-control" rows="3" placeholder="Keterangan penuh dalam Bahasa Melayu...">{{ old('description_bm', $product->description_bm) }}</textarea>
                    </div>
                </div>
            </div>
                        ...
                        <div style="display:flex;gap:8px;align-items:center;">
                            <div style="position:relative;width:64px;flex-shrink:0;">
                                <input type="text" name="storage_icon" id="storage_icon" class="form-control text-center"
                                       value="{{ old('storage_icon', $product->storage_icon ?? $product->getStorageIcon()) }}"
                            ...
                            <input type="text" name="storage_temp" id="storage_temp" class="form-control" style="flex:1;"
                                   value="{{ old('storage_temp', $product->storage_temp ?? '-18°C') }}" placeholder="e.g. Live / Chilled, -18°C Frozen">
                        </div>
