    ...
    <div class="container" style="position:relative;z-index:2">
        <div class="walkin-show-top-nav">
            <div>
                ...
                <h1 class="walkin-hero-product-title">
                    {{ $product->name }}
                </h1>
            </div>

            <div class="walkin-hero-top-actions">
    ...
    <div class="walkin-detail-grid">
        ...
        <div class="walkin-info-col">
            ...
            <div class="walkin-price-card">
                ...
                @else
                    <div class="price-card-value-row">
                        <span class="price-upon-request-text">@t('walkin.price_upon_request', 'Price Available Upon Request')</span>
                    </div>
                @endif
            ...
            @else
                <div class="walkin-quote-action-wrap" style="margin-bottom:26px">
                    <a href="{{ route('quotations.create', ['product' => $product->id]) }}" class="btn-walkin-add-main" style="display:inline-flex;align-items:center;justify-content:center;text-decoration:none;background:#2563eb">
            ...
            <div class="walkin-specs-card">
                ...
                <div class="specs-grid">
                    @if($product->weight)
                        <div class="spec-name">@t('walkin.weight_spec', 'Weight / Pack Size')</div>
